...
import 'package:healthy_steps/commons/progress.dart';
...
class DinnerPage extends StatelessWidget {
  ...
  const DinnerPage({Key? key, required this.dinner}) : super(key: key);
  @override
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                image: AssetImage(dinner.bgimage),
                fit: BoxFit.cover,
              ),
            ),
            child: Stack(
